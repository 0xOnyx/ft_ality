error id: file://<WORKSPACE>/src/main/scala/input/MainLoop.scala:toLowerCase.
file://<WORKSPACE>/src/main/scala/input/MainLoop.scala
empty definition using pc, found symbol in pc: toLowerCase.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -keychar/toString/toLowerCase.
	 -keychar/toString/toLowerCase#
	 -keychar/toString/toLowerCase().
	 -scala/Predef.keychar.toString.toLowerCase.
	 -scala/Predef.keychar.toString.toLowerCase#
	 -scala/Predef.keychar.toString.toLowerCase().
offset: 982
  ...
  def mainloop(automaton: Automaton, mapping: Map[String, String]): Unit = {
    ...
    def loop(
      ...
      if (automaton.finalStates.contains(currentState) && timeSinceLastKey > COMBO_DELAY_MS ){
        ...
        key match {
          case Some(keychar) =>
            val keyStr = keychar.toString.toL@@owerCase()
